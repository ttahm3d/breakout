  ...
  return (
    <HeroContainer>
      <HeroText>
        <div className="title">
          <div>
            <span className="violet">Burnout?</span>
          </div>
          <div>
            <span className="plum">Breakout.</span>
          </div>
        </div>
      ...
      <HeroImage>
        <img
          src="https://res.cloudinary.com/dut75albw/image/upload/v1658493138/breakout/Breakout_gcvxkp.png"
          alt="preview"
        />
      </HeroImage>
    </HeroContainer>
